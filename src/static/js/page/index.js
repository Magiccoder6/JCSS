...
$(function() {
   ...
   // Stacked Area
   if(document.getElementById('apex-stacked-area') != null){
    $(document).ready(function() {
      var options = {
          ...
          series: [
              {
                  name: 'Patient',
                  data: generateDayWiseTimeSeries(new Date('05 Apr 2024 GMT').getTime(), 20, {
                      min: 10,
                      max: 60
                  })
              }
    ...
    if(document.getElementById('hiringsources') != null){
      $(document).ready(function() {
